...
func commandMap(pokedex map[string]pokeapi.PokemonDataConfig, cache *pokecache.Cache, locConfig *pokeapi.LocationConfig, pokemonConfig *pokeapi.PokemonConfig, pokemonDataConfig *pokeapi.PokemonDataConfig, args []string) error {
	var url string
